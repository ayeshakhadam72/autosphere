...
const Popularcars = (  ) => {
  ...
  const MyOpenBox = (a) => {
    setTogglebox(true)
    console.log(a)
    setSavedata(a.productname)

    // alert(a.productname)
  }
 

console.log(togglebox , 'helo' )
 ...
 '>
                          ...
                          <div className=' rounded-md bg-[#201F1D] hover:bg-[#127384] text-[#ffffff] py-[7px] px-[10px] flex justify-center'>
                            <button onClick={() => MyOpenBox(b)} className='text-[16px] font-[500] flex items-center gap-2'> <FaRegCalendarAlt /> Rent Now</button>
                          </div>
                          {/*  */}
                        </div>
                ...
                <div  className={` ${togglebox ? 'flex' : 'hidden'}   justify-center items-center z-50  bg-[#00000033] h-[100vh] w-screen fixed left-0 top-0  `}>
                 <MultiStepForm OpenBox={OpenBox} savedata={savedata} setTogglebox={setTogglebox} />
